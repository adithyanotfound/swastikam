...
export default function VoiceKiosk() {
  ...
  const toggleAudio = () => {
    ...
    // Don't replay messages when unmuting - only speak new messages
  ...
  useEffect(() => {
    ...
    addBotMessage("Hi! I'm the desk assistant. I can help you book appointments with Dr. Kumar Awadhesh. Would you like to book one?")
  }, [])
